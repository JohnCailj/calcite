...
class ElasticsearchRules {
    ...
    static final RelOptRule[] RULES = { ElasticsearchSortRule.INSTANCE, ElasticsearchFilterRule.INSTANCE,
    ...
    static String isItem(RexCall call) {
        ...
        if (op0 instanceof RexInputRef && ((RexInputRef) op0).getIndex() == 0 && op1 instanceof RexLiteral
    ...
    static class RexToElasticsearchTranslator extends RexVisitorImpl<String> {
        ...
        @Override public String visitLiteral(RexLiteral literal) {
            ...
            return "\"literal\":\"" + RexToLixTranslator.translateLiteral(literal, literal.getType(), typeFactory,
        ...
        @Override public String visitCall(RexCall call) {
            ...
            throw new IllegalArgumentException(
                    "Translation of " + call.toString() + "is not supported by ElasticsearchProject");
        }
    ...
    private static class ElasticsearchFilterRule extends ElasticsearchConverterRule {
        ...
        @Override public RelNode convert(RelNode relNode) {
            ...
            return new ElasticsearchFilter(relNode.getCluster(), traitSet, convert(filter.getInput(), out),
                                           filter.getCondition());
        }
    }
    ...
    private static class ElasticsearchProjectRule extends ElasticsearchConverterRule {
        ...
        @Override public RelNode convert(RelNode relNode) {
            ...
            return new ElasticsearchProject(project.getCluster(), traitSet, convert(project.getInput(), out),
