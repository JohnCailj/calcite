...
public class ElasticsearchToEnumerableConverter extends ConverterImpl implements EnumerableRel {
    ...
    @Override public Result implement(EnumerableRelImplementor implementor, Prefer prefer) {
        ...
        final Expression fields = list.append("fields", constantArrayList(
                Pair.zip(ElasticsearchRules.elasticsearchFieldNames(rowType), new AbstractList<Class>() {
        ...
        final Expression table = list.append("table", elasticsearchImplementor.table.getExpression(
                AbstractElasticsearchTable.ElasticsearchQueryable.class));
    ...
    private static <T> List<Expression> constantList(List<T> values) {
        return Lists.transform(values, new Function<T, Expression>() {
            ...
            @Nullable @Override public Expression apply(@Nullable T t) {
