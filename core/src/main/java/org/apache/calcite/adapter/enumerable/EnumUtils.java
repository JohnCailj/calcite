...
public class EnumUtils {
    ...
    private static final Function<RexNode, Type> REX_TO_INTERNAL_TYPE = new Function<RexNode, Type>() {
     ...
     */
    public static MethodDeclaration overridingMethodDecl(Method method, Iterable<ParameterExpression> parameters,
                                                         BlockStatement body) {
        return Expressions.methodDecl(method.getModifiers() & ~Modifier.ABSTRACT, method.getReturnType(),
                                      method.getName(), parameters, body);
    }
    ...
    static List<RelDataType> fieldRowTypes(final RelDataType inputRowType, final List<? extends RexNode> extraInputs,
        ...
        return new AbstractList<RelDataType>() {
            ...
            public RelDataType get(int index) {
                ...
                return arg < inputFields.size() ? inputFields.get(arg).getType() : extraInputs.get(
                        arg - inputFields.size()).getType();
            }
