...
public class EnumerableTableScan extends TableScan implements EnumerableRel {
        ...
        if (table instanceof QueryableTable) {
            ...
            if (type instanceof Class) {
                ...
                return Object[].class;
                   ...
                   || table instanceof ProjectableFilterableTable || table instanceof StreamableTable) {
            return Object[].class;
        } else {
            return Object.class;
        }
    ...
    private Expression toRows(PhysType physType, Expression expression) {
        if (physType.getFormat() == JavaRowFormat.SCALAR && Object[].class.isAssignableFrom(elementType)
            && getRowType().getFieldCount() == 1 && (table.unwrap(ScannableTable.class) != null
    ...
    private Expression fieldExpression(ParameterExpression row_, int i, PhysType physType, JavaRowFormat format) {
        ...
        switch (relFieldType.getSqlTypeName()) {
            ...
            case MULTISET:
                ...
                final PhysType elementPhysType = PhysTypeImpl.of(typeFactory, relFieldType.getComponentType(),
                ...
                final Expression e3 = elementPhysType.convertTo(e2, PhysTypeImpl.of(typeFactory, dummyType,
                                                                                    JavaRowFormat.LIST));
    ...
    private JavaRowFormat format() {
        ...
        if (fieldCount == 1 && (Object.class == elementType || Primitive.is(elementType)
