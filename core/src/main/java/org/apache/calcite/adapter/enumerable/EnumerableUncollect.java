...
public class EnumerableUncollect extends Uncollect implements EnumerableRel {
    ...
    @Override public EnumerableUncollect copy(RelTraitSet traitSet, RelNode newInput) {
    ...
    public Result implement(EnumerableRelImplementor implementor, Prefer pref) {
        ...
        final Expression lambda = Expressions.call(BuiltInMethod.FLAT_PRODUCT.method,
                                                   Expressions.constant(Ints.toArray(fieldCounts)),
                                                   Expressions.constant(withOrdinality), Expressions.constant(
