...
public class JdbcRules {
    ...
    public static List<RelOptRule> rules(JdbcConvention out) {
        return ImmutableList.<RelOptRule>of(new JdbcToEnumerableConverterRule(out), new JdbcJoinRule(out),
                                            new JdbcCalcRule(out), new JdbcProjectRule(out), new JdbcFilterRule(out),
                                            new JdbcAggregateRule(out), new JdbcSortRule(out), new JdbcUnionRule(out),
                                            new JdbcIntersectRule(out), new JdbcMinusRule(out),
                                            new JdbcTableModificationRule(out), new JdbcValuesRule(out));
    }
    ...
    public static class JdbcJoin extends Join implements JdbcRel {
        ...
        @Override public JdbcJoin copy(RelTraitSet traitSet, RexNode condition, RelNode left, RelNode right,
    ...
    public static class JdbcProject extends Project implements JdbcRel {
        ...
        @Override public JdbcProject copy(RelTraitSet traitSet, RelNode input, List<RexNode> projects,
                                          RelDataType rowType) {
    ...
    private static class JdbcAggregateRule extends JdbcConverterRule {
        ...
        public RelNode convert(RelNode rel) {
            ...
            try {
                return new JdbcAggregate(rel.getCluster(), traitSet, convert(agg.getInput(), out), agg.indicator,
    ...
    public static class JdbcAggregate extends Aggregate implements JdbcRel {
        ...
        @Override public JdbcAggregate copy(RelTraitSet traitSet, RelNode input, boolean indicator,
    ...
    private static class JdbcSortRule extends JdbcConverterRule {
        ...
        public RelNode convert(RelNode rel) {
            ...
            return new JdbcSort(rel.getCluster(), traitSet, convert(sort.getInput(), traitSet), sort.getCollation());
        }
    }
    ...
    public static class JdbcSort extends Sort implements JdbcRel {
        ...
        @Override public JdbcSort copy(RelTraitSet traitSet, RelNode newInput, RelCollation newCollation,
    ...
    public static class JdbcTableModificationRule extends JdbcConverterRule {
        ...
        private JdbcTableModificationRule(JdbcConvention out) {
            super(LogicalTableModify.class, Convention.NONE, out, "JdbcTableModificationRule");
        }
