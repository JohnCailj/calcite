...
public enum CalciteConnectionProperty implements ConnectionProperty {
    ...
    CalciteConnectionProperty(String camelName, Type type, Object defaultValue, boolean required) {
        this(camelName, type, defaultValue, required, null);
    }

    CalciteConnectionProperty(String camelName, Type type, Object defaultValue, boolean required, Class valueClass) {
