...
public interface CalcitePrepare {
    ...
    Function0<CalcitePrepare>   DEFAULT_FACTORY      = new Function0<CalcitePrepare>() {

        public CalcitePrepare apply() {
            return new CalcitePrepareImpl();
        }
    };
    ThreadLocal<Deque<Context>> THREAD_CONTEXT_STACK = new ThreadLocal<Deque<Context>>() {
    ...
    class Dummy {
        ...
        private static SparkHandler createHandler() {
            try {
                final Class<?> clazz = Class.forName("org.apache.calcite.adapter.spark.SparkHandlerImpl");
    ...
    class ParseResult {
        ...
        public ParseResult(CalcitePrepareImpl prepare, SqlValidator validator, String sql, SqlNode sqlNode,
                           RelDataType rowType) {
            super();
    ...
    class ConvertResult extends ParseResult {
        ...
        public ConvertResult(CalcitePrepareImpl prepare, SqlValidator validator, String sql, SqlNode sqlNode,
                             RelDataType rowType, RelRoot root) {
    ...
    class AnalyzeViewResult extends ConvertResult {
        ...
        public AnalyzeViewResult(CalcitePrepareImpl prepare, SqlValidator validator, String sql, SqlNode sqlNode,
                                 RelDataType rowType, RelRoot root, Table table, ImmutableList<String> tablePath,
    ...
    class CalciteSignature<T> extends Meta.Signature {
        ...
        public CalciteSignature(String sql, List<AvaticaParameter> parameterList,
                                ...
                                CalciteSchema rootSchema, List<RelCollation> collationList, long maxRowCount,
                                Bindable<T> bindable) {
        ...
        public CalciteSignature(String sql, List<AvaticaParameter> parameterList,
                                ...
                                List<ColumnMetaData> columns, Meta.CursorFactory cursorFactory,
                                CalciteSchema rootSchema, List<RelCollation> collationList, long maxRowCount,
                                Bindable<T> bindable, Meta.StatementType statementType) {
