...
public abstract class CalciteStatement extends AvaticaStatement {
     ...
     */
    CalciteStatement(CalciteConnectionImpl connection, Meta.StatementHandle h, int resultSetType,
    ...
    @Override protected void close_() {
        if (!closed) {
            closed = true;
            final CalciteConnectionImpl connection1 = (CalciteConnectionImpl) connection;
