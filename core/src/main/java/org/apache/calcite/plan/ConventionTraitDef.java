...
public class ConventionTraitDef extends RelTraitDef<Convention> {
     ...
     */
    private final LoadingCache<RelOptPlanner, ConversionData> conversionCache = CacheBuilder.newBuilder().weakKeys().build(
     ...
     * arc.
     */
    private RelNode changeConvention(RelNode rel, Convention source, Convention target,
