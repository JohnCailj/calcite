...
public interface RelOptListener extends EventListener {
    ...
    class RelEquivalenceEvent extends RelEvent {
        ...
        public RelEquivalenceEvent(Object eventSource, RelNode rel, Object equivalenceClass, boolean isPhysical) {
            super(eventSource, rel);
    ...
    class RuleAttemptedEvent extends RuleEvent {
        ...
        public RuleAttemptedEvent(Object eventSource, RelNode rel, RelOptRuleCall ruleCall, boolean before) {
    ...
    class RuleProductionEvent extends RuleAttemptedEvent {
        ...
        public RuleProductionEvent(Object eventSource, RelNode rel, RelOptRuleCall ruleCall, boolean before) {
