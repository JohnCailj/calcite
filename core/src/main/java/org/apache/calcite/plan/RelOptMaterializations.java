...
public abstract class RelOptMaterializations {
    ...
    public static List<RelOptMaterialization> getApplicableMaterializations(RelNode rel,
        ...
        for (List<String> qname : TopologicalOrderIterator.of(usesGraph)) {
            ...
            if (materialization != null && usesTable(materialization.qualifiedTableName, queryTablesUsed,
                                                     frozenGraph)) {
    ...
    private static List<RelNode> substitute(RelNode root, RelOptMaterialization materialization) {
        ...
        HepProgram program = new HepProgramBuilder().addRuleInstance(
                ...
                ProjectRemoveRule.INSTANCE).build();
     ...
     * {@code usedTables}.
     */
    private static boolean usesTable(List<String> qualifiedName, Set<RelOptTable> usedTables,
