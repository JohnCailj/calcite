...
public class PlannerImpl implements Planner {
    ...
    @SuppressWarnings("deprecation") public final RelNode convert(SqlNode sql) throws RelConversionException {
        return rel(sql).rel;
    }
    ...
    public RelRoot rel(SqlNode sql) throws RelConversionException {
        ...
        final SqlToRelConverter.Config config = SqlToRelConverter.configBuilder().withConfig(
                sqlToRelConverterConfig).withTrimUnusedFields(false).withConvertTableAccess(false).build();
        final SqlToRelConverter sqlToRelConverter = new SqlToRelConverter(new ViewExpanderImpl(), validator,
    ...
    public class ViewExpanderImpl implements ViewExpander {
        ...
        @Override public RelRoot expandView(RelDataType rowType, String queryString, List<String> schemaPath,
            ...
            final SqlValidator validator = new CalciteSqlValidator(operatorTable, catalogReader, typeFactory,
                                                                   conformance);
    ...
    public RelNode transform(int ruleSetIndex, RelTraitSet requiredOutputTraits, RelNode rel)
        ...
        return program.run(planner, rel, requiredOutputTraits, ImmutableList.<RelOptMaterialization>of(),
