...
public abstract class AbstractRelNode implements RelNode {
    ...
    public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        ...
        throw new AssertionError(
                "Relational expression should override copy. " + "Class=[" + getClass() + "]; traits=[" + getTraitSet()
    ...
    @SuppressWarnings("deprecation") public List<RexNode> getChildExps() {
    ...
    @SuppressWarnings("deprecation") public boolean isDistinct() {
        final RelMetadataQuery mq = RelMetadataQuery.instance();
        return Boolean.TRUE.equals(mq.areRowsUnique(this));
    }

    @SuppressWarnings("deprecation") public boolean isKey(ImmutableBitSet columns) {
        final RelMetadataQuery mq = RelMetadataQuery.instance();
    ...
    @SuppressWarnings("deprecation") public final RelOptQuery getQuery() {
    ...
    @SuppressWarnings("deprecation") public boolean isValid(boolean fail) {
    ...
    @SuppressWarnings("deprecation") public final double getRows() {
    ...
    @SuppressWarnings("deprecation") public final Set<String> getVariablesStopped() {
    ...
    @SuppressWarnings("deprecation") public final RelOptCost computeSelfCost(RelOptPlanner planner) {
    ...
    public final <M extends Metadata> M metadata(Class<M> metadataClass, RelMetadataQuery mq) {
        ...
        assert metadata != null :
                "no provider found (rel=" + this + ", m=" + metadataClass + "); a backstop provider is recommended";
    ...
    public RelNode onRegister(RelOptPlanner planner) {
        ...
        for (final RelNode input : oldInputs) {
            ...
            if (e != input) {
                ...
                assert RelOptUtil.equal("rowtype of rel before registration", input.getRowType(),
                                        "rowtype of rel after registration", e.getRowType(), Litmus.THROW);
            }
            inputs.add(e);
        }
        RelNode r = this;
