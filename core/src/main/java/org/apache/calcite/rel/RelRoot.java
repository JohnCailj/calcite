...
public class RelRoot {
    ...
    public RelRoot(RelNode rel, RelDataType validatedRowType, SqlKind kind, List<Pair<Integer, String>> fields,
    ...
    @Override public String toString() {
        return "Root {kind: " + kind + ", rel: " + rel + ", rowType: " + validatedRowType + ", fields: " + fields
               + ", collation: " + collation + "}";
    }
    ...
    public boolean isCollationTrivial() {
        ...
        return collations != null && collations.size() == 1 && collations.get(0).equals(collation);
    }
}
