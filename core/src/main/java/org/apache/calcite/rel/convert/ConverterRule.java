...
public abstract class ConverterRule extends RelOptRule {
     ...
     * @param description Description of rule
     */
    public <R extends RelNode> ConverterRule(Class<R> clazz, Predicate<? super R> predicate, RelTrait in, RelTrait out,
                                             String description) {
        super(convertOperand(clazz, predicate, in),
              description == null ? "ConverterRule<in=" + in + ",out=" + out + ">" : description);
