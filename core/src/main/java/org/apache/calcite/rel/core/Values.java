...
public abstract class Values extends AbstractRelNode {
     ...
     */
    public static final Predicate<? super Values> IS_EMPTY = new PredicateImpl<Values>() {
     ...
     * expressions and prune away that section of the tree.
     */
    public static final Predicate<? super Values> IS_NOT_EMPTY = new PredicateImpl<Values>() {
     ...
     */
    protected Values(RelOptCluster cluster, RelDataType rowType, ImmutableList<ImmutableList<RexLiteral>> tuples,
                     RelTraitSet traits) {
    ...
    public RelWriter explainTerms(RelWriter pw) {
        ...
        return super.explainTerms(pw)
                    ...
                    .itemIf("type", rowType, pw.getDetailLevel() == SqlExplainLevel.DIGEST_ATTRIBUTES).itemIf("type",
                                                                                                              rowType.getFieldList(),
                                                                                                              pw.nest()).itemIf(
                        "tuples", Lists.transform(tuples, F), !pw.nest()).itemIf("tuples", tuples, pw.nest());
    }
}
