    ...
    @Override public boolean isValid(Litmus litmus, Context context) {
        ...
        final List<RelDataType> inputTypes = new AbstractList<RelDataType>() {
            ...
            @Override public RelDataType get(int index) {
                return index < childFieldCount ? childRowType.getFieldList().get(index).getType() : constants.get(
                        index - childFieldCount).getType();
            }
        ...
        public List<AggregateCall> getAggregateCalls(Window windowRel) {
            ...
            return new AbstractList<AggregateCall>() {
                ...
                public AggregateCall get(int index) {
                    ...
                    return AggregateCall.create((SqlAggFunction) aggCall.getOperator(), aggCall.distinct,
                                                getProjectOrdinals(aggCall.getOperands()), -1, aggCall.getType(),
