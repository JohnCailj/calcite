...
public class RelJson {
    ...
    public RelFieldCollation toFieldCollation(Map<String, Object> map) {
        ...
        final RelFieldCollation.Direction direction = Util.enumVal(RelFieldCollation.Direction.class,
                                                                   (String) map.get("direction"));
        final RelFieldCollation.NullDirection nullDirection = Util.enumVal(RelFieldCollation.NullDirection.class,
