...
public final class LogicalWindow extends Window {
    ...
    public static RelNode create(RelOptCluster cluster, RelTraitSet traitSet, RelBuilder relBuilder, RelNode child,
        ...
        final List<Map.Entry<String, RelDataType>> fieldList = new ArrayList<Map.Entry<String, RelDataType>>(
    ...
    private static class WindowKey {
        ...
        @Override public boolean equals(Object obj) {
            return obj == this || obj instanceof WindowKey && groupSet.equals(((WindowKey) obj).groupSet)
                                  && orderKeys.equals(((WindowKey) obj).orderKeys) && Objects.equals(lowerBound,
                                                                                                     ((WindowKey) obj).lowerBound)
    ...
    private static void addWindows(Multimap<WindowKey, RexOver> windowMap, RexOver over, final int inputFieldCount) {
        ...
        RelCollation orderKeys = getCollation(
                Lists.newArrayList(Iterables.filter(aggWindow.orderKeys, new PredicateImpl<RexFieldCollation>() {
