...
public abstract class BuiltInMetadata {
    ...
    public interface Selectivity extends Metadata {
        ...
        MetadataDef<Selectivity> DEF = MetadataDef.of(Selectivity.class, Selectivity.Handler.class,
    ...
    public interface UniqueKeys extends Metadata {
        ...
        MetadataDef<UniqueKeys> DEF = MetadataDef.of(UniqueKeys.class, UniqueKeys.Handler.class,
    ...
    public interface ColumnUniqueness extends Metadata {
        ...
        MetadataDef<ColumnUniqueness> DEF = MetadataDef.of(ColumnUniqueness.class, ColumnUniqueness.Handler.class,
    ...
    public interface Collation extends Metadata {
        ...
        MetadataDef<Collation> DEF = MetadataDef.of(Collation.class, Collation.Handler.class,
    ...
    public interface Distribution extends Metadata {
        ...
        MetadataDef<Distribution> DEF = MetadataDef.of(Distribution.class, Distribution.Handler.class,
    ...
    public interface NodeTypes extends Metadata {
        ...
        MetadataDef<NodeTypes> DEF = MetadataDef.of(NodeTypes.class, NodeTypes.Handler.class,
    ...
    public interface RowCount extends Metadata {
        ...
        MetadataDef<RowCount> DEF = MetadataDef.of(RowCount.class, RowCount.Handler.class,
    ...
    public interface MaxRowCount extends Metadata {
        ...
        MetadataDef<MaxRowCount> DEF = MetadataDef.of(MaxRowCount.class, MaxRowCount.Handler.class,
    ...
    public interface MinRowCount extends Metadata {
        ...
        MetadataDef<MinRowCount> DEF = MetadataDef.of(MinRowCount.class, MinRowCount.Handler.class,
    ...
    public interface DistinctRowCount extends Metadata {
        ...
        MetadataDef<DistinctRowCount> DEF = MetadataDef.of(DistinctRowCount.class, DistinctRowCount.Handler.class,
    ...
    public interface PercentageOriginalRows extends Metadata {
        ...
        MetadataDef<PercentageOriginalRows> DEF = MetadataDef.of(PercentageOriginalRows.class,
    ...
    public interface PopulationSize extends Metadata {
        ...
        MetadataDef<PopulationSize> DEF = MetadataDef.of(PopulationSize.class, PopulationSize.Handler.class,
    ...
    public interface Size extends Metadata {
        ...
        MetadataDef<Size> DEF = MetadataDef.of(Size.class, Size.Handler.class, BuiltInMethod.AVERAGE_ROW_SIZE.method,
    ...
    public interface ColumnOrigin extends Metadata {
        ...
        MetadataDef<ColumnOrigin> DEF = MetadataDef.of(ColumnOrigin.class, ColumnOrigin.Handler.class,
    ...
    public interface ExpressionLineage extends Metadata {
        ...
        MetadataDef<ExpressionLineage> DEF = MetadataDef.of(ExpressionLineage.class, ExpressionLineage.Handler.class,
    ...
    public interface TableReferences extends Metadata {
        ...
        MetadataDef<TableReferences> DEF = MetadataDef.of(TableReferences.class, TableReferences.Handler.class,
    ...
    public interface CumulativeCost extends Metadata {
        ...
        MetadataDef<CumulativeCost> DEF = MetadataDef.of(CumulativeCost.class, CumulativeCost.Handler.class,
    ...
    public interface NonCumulativeCost extends Metadata {
        ...
        MetadataDef<NonCumulativeCost> DEF = MetadataDef.of(NonCumulativeCost.class, NonCumulativeCost.Handler.class,
    ...
    public interface ExplainVisibility extends Metadata {
        ...
        MetadataDef<ExplainVisibility> DEF = MetadataDef.of(ExplainVisibility.class, ExplainVisibility.Handler.class,
    ...
    public interface Predicates extends Metadata {
        ...
        MetadataDef<Predicates> DEF = MetadataDef.of(Predicates.class, Predicates.Handler.class,
    ...
    public interface AllPredicates extends Metadata {
        ...
        MetadataDef<AllPredicates> DEF = MetadataDef.of(AllPredicates.class, AllPredicates.Handler.class,
    ...
    public interface Parallelism extends Metadata {
        ...
        MetadataDef<Parallelism> DEF = MetadataDef.of(Parallelism.class, Parallelism.Handler.class,
    ...
    public interface Memory extends Metadata {
        ...
        MetadataDef<Memory> DEF = MetadataDef.of(Memory.class, Memory.Handler.class, BuiltInMethod.MEMORY.method,
     ...
     */
    interface All
            extends Selectivity, UniqueKeys, RowCount, DistinctRowCount, PercentageOriginalRows, ColumnUniqueness, ColumnOrigin, Predicates, Collation, Distribution, Size, Parallelism, Memory, AllPredicates, ExpressionLineage, TableReferences, NodeTypes {
