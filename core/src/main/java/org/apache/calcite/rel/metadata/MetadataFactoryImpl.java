...
public class MetadataFactoryImpl implements MetadataFactory {
    ...
    @SuppressWarnings("unchecked") public static final UnboundMetadata<Metadata> DUMMY = new UnboundMetadata<Metadata>() {
    ...
    private static CacheLoader<Pair<Class<RelNode>, Class<Metadata>>, UnboundMetadata<Metadata>> loader(
            final RelMetadataProvider provider) {
        return new CacheLoader<Pair<Class<RelNode>, Class<Metadata>>, UnboundMetadata<Metadata>>() {

            @Override public UnboundMetadata<Metadata> load(Pair<Class<RelNode>, Class<Metadata>> key)
                    throws Exception {
    ...
    public <M extends Metadata> M query(RelNode rel, RelMetadataQuery mq, Class<M> metadataClazz) {
        try {
            ...
            final Pair<Class<RelNode>, Class<Metadata>> key = (Pair) Pair.of(rel.getClass(), metadataClazz);
