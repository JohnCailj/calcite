...
public class RelMetadataQuery {
    ...
    protected static <H> H initialHandler(Class<H> handlerClass) {
        return handlerClass.cast(
                Proxy.newProxyInstance(RelMetadataQuery.class.getClassLoader(), new Class[] { handlerClass },
     ...
     */
    protected <M extends Metadata, H extends MetadataHandler<M>> H revise(Class<? extends RelNode> class_,
                                                                          MetadataDef<M> def) {
    ...
    public List<Double> getAverageColumnSizesNotNull(RelNode rel) {
        ...
        return averageColumnSizes == null ? Collections.<Double>nCopies(rel.getRowType().getFieldCount(),
                                                                        null) : averageColumnSizes;
    }
    ...
    public RelDistribution getDistribution(RelNode rel) {
        final BuiltInMetadata.Distribution metadata = rel.metadata(BuiltInMetadata.Distribution.class, this);
