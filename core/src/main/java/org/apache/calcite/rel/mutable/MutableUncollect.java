...
public class MutableUncollect extends MutableSingleRel {
    ...
    private MutableUncollect(RelDataType rowType, MutableRel input, boolean withOrdinality) {
    ...
    @Override public boolean equals(Object obj) {
        return obj == this
               || obj instanceof MutableUncollect && withOrdinality == ((MutableUncollect) obj).withOrdinality
    ...
    @Override public StringBuilder digest(StringBuilder buf) {
        return buf.append("Uncollect(withOrdinality: ").append(withOrdinality).append(")");
    }
