...
public class AggregateFilterTransposeRule extends RelOptRule {
    ...
    protected AggregateFilterTransposeRule(RelOptRuleOperand operand, RelBuilderFactory relBuilderFactory) {
    ...
    public void onMatch(RelOptRuleCall call) {
        ...
        if (allColumnsInAggregate && aggregate.getGroupSets().size() == 1) {
            ...
            for (AggregateCall aggregateCall : aggregate.getAggCallList()) {
                ...
                topAggCallList.add(AggregateCall.create(rollup, aggregateCall.isDistinct(), ImmutableList.of(i++), -1,
