...
public class IntersectToDistinctRule extends RelOptRule {
    ...
    public static final IntersectToDistinctRule INSTANCE = new IntersectToDistinctRule(LogicalIntersect.class,
    ...
    public void onMatch(RelOptRuleCall call) {
        ...
        relBuilder.filter(relBuilder.equals(relBuilder.field(fieldCount - 1),
