...
public final class MultiJoin extends AbstractRelNode {
     ...
     */
    public MultiJoin(RelOptCluster cluster, List<RelNode> inputs, RexNode joinFilter, RelDataType rowType,
                     boolean isFullOuterJoin, List<RexNode> outerJoinConditions, List<JoinRelType> joinTypes,
                     List<ImmutableBitSet> projFields, ImmutableMap<Integer, ImmutableIntList> joinFieldRefCountsMap,
    ...
    @Override public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        ...
        return new MultiJoin(getCluster(), inputs, joinFilter, rowType, isFullOuterJoin, outerJoinConditions, joinTypes,
    ...
    public RelWriter explainTerms(RelWriter pw) {
        ...
        return pw.item("joinFilter", joinFilter).item("isFullOuterJoin", isFullOuterJoin).item("joinTypes",
                                                                                               joinTypeNames).item(
                "outerJoinConditions", outerJoinConds).item("projFields", projFieldObjects).itemIf("postJoinFilter",
                                                                                                   postJoinFilter,
                                                                                                   postJoinFilter
                                                                                                   != null);
    }
    ...
    public RelNode accept(RexShuttle shuttle) {
        ...
        if (joinFilter == this.joinFilter && outerJoinConditions == this.outerJoinConditions
