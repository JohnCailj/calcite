...
public class ProjectWindowTransposeRule extends RelOptRule {
    ...
    private ProjectWindowTransposeRule() {
        super(operand(LogicalProject.class, operand(LogicalWindow.class, any())));
    }
        ...
        final RexShuttle indexAdjustment = new RexShuttle() {
            ...
            @Override public RexNode visitCall(final RexCall call) {
                if (call instanceof Window.RexWinAggCall) {
                    ...
                    if (update[0]) {
                        return new Window.RexWinAggCall((SqlAggFunction) call.getOperator(), call.getType(),
                                                        clonedOperands, ((Window.RexWinAggCall) call).ordinal,
