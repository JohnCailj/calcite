...
public abstract class PruneEmptyRules {
     ...
     * </ul>
     */
    public static final RelOptRule UNION_INSTANCE = new RelOptRule(
            operand(LogicalUnion.class, unordered(operand(Values.class, null, Values.IS_EMPTY, none()))), "Union") {
     ...
     * </ul>
     */
    public static final RelOptRule MINUS_INSTANCE = new RelOptRule(
            operand(LogicalMinus.class, unordered(operand(Values.class, null, Values.IS_EMPTY, none()))), "Minus") {
     ...
     * </ul>
     */
    public static final RelOptRule INTERSECT_INSTANCE = new RelOptRule(
            operand(LogicalIntersect.class, unordered(operand(Values.class, null, Values.IS_EMPTY, none()))),
            "Intersect") {
     ...
     * </ul>
     */
    public static final RelOptRule PROJECT_INSTANCE = new RemoveEmptySingleRule(Project.class,
                                                                                Predicates.<Project>alwaysTrue(),
     ...
     * </ul>
     */
    public static final RelOptRule SORT_FETCH_ZERO_INSTANCE = new RelOptRule(operand(Sort.class, any()),
                                                                             "PruneSortLimit0") {
     ...
     */
    public static final RelOptRule AGGREGATE_INSTANCE = new RemoveEmptySingleRule(Aggregate.class,
     ...
     * </ul>
     */
    public static final RelOptRule JOIN_LEFT_INSTANCE = new RelOptRule(operand(Join.class,
                                                                               some(operand(Values.class, null,
                                                                                            Values.IS_EMPTY, none()),
     ...
     * </ul>
     */
    public static final RelOptRule JOIN_RIGHT_INSTANCE = new RelOptRule(operand(Join.class,
                                                                                some(operand(RelNode.class, any()),
                                                                                     operand(Values.class, null,
                                                                                             Values.IS_EMPTY, none()))),
    ...
    public static class RemoveEmptySingleRule extends RelOptRule {
        ...
        public <R extends SingleRel> RemoveEmptySingleRule(Class<R> clazz, String description) {
            this(clazz, Predicates.<R>alwaysTrue(), RelFactories.LOGICAL_BUILDER, description);
        }

        /**
         * Creates a RemoveEmptySingleRule.
         */
        public <R extends SingleRel> RemoveEmptySingleRule(Class<R> clazz, Predicate<R> predicate,
                                                           RelBuilderFactory relBuilderFactory, String description) {
            super(operand(clazz, null, predicate, operand(Values.class, null, Values.IS_EMPTY, none())),
