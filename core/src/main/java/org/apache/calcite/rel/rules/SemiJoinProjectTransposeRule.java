...
public class SemiJoinProjectTransposeRule extends RelOptRule {
    ...
    private SemiJoinProjectTransposeRule(RelBuilderFactory relBuilderFactory) {
        super(operand(SemiJoin.class, some(operand(LogicalProject.class, any()))), relBuilderFactory, null);
    }
    ...
    public void onMatch(RelOptRuleCall call) {
        ...
        SemiJoin newSemiJoin = SemiJoin.create(project.getInput(), semiJoin.getRight(), newCondition,
    ...
    private RexNode adjustCondition(LogicalProject project, SemiJoin semiJoin) {
        ...
        RelDataType bottomInputRowType = SqlValidatorUtil.deriveJoinRowType(project.getInput().getRowType(),
                                                                            rightChild.getRowType(), JoinRelType.INNER,
                                                                            typeFactory, null,
        ...
        RelDataType topInputRowType = SqlValidatorUtil.deriveJoinRowType(project.getRowType(), rightChild.getRowType(),
                                                                         JoinRelType.INNER, typeFactory, null,
                                                                         semiJoin.getSystemFieldList());
