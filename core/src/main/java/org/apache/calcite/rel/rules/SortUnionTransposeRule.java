...
public class SortUnionTransposeRule extends RelOptRule {
     ...
     */
    public SortUnionTransposeRule(Class<? extends Sort> sortClass, Class<? extends Union> unionClass,
                                  boolean matchNullFetch, RelBuilderFactory relBuilderFactory, String description) {
        super(operand(sortClass, operand(unionClass, any())), relBuilderFactory, description);
