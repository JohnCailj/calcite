...
public abstract class SubQueryRemoveRule extends RelOptRule {
    ...
    public static final SubQueryRemoveRule PROJECT = new SubQueryRemoveRule(
            operand(Project.class, null, RexUtil.SubQueryFinder.PROJECT_PREDICATE, any()), RelFactories.LOGICAL_BUILDER,
        ...
        public void onMatch(RelOptRuleCall call) {
            ...
            final RexNode target = apply(e, ImmutableSet.<CorrelationId>of(), logic, builder, 1, fieldCount);
    ...
    public static final SubQueryRemoveRule FILTER = new SubQueryRemoveRule(
            operand(Filter.class, null, RexUtil.SubQueryFinder.FILTER_PREDICATE, any()), RelFactories.LOGICAL_BUILDER,
        ...
        public void onMatch(RelOptRuleCall call) {
            ...
            for (; ; ) {
                ...
                final RexNode target = apply(e, filter.getVariablesSet(), logic, builder, 1,
    ...
    public static final SubQueryRemoveRule JOIN = new SubQueryRemoveRule(
            operand(Join.class, null, RexUtil.SubQueryFinder.JOIN_PREDICATE, any()), RelFactories.LOGICAL_BUILDER,
        ...
        public void onMatch(RelOptRuleCall call) {
            ...
            final RexNode target = apply(e, ImmutableSet.<CorrelationId>of(), logic, builder, 2, fieldCount);
            final RexShuttle shuttle = new ReplaceSubQueryShuttle(e, target);
            ...
            case SCALAR_QUERY:
                ...
                if (unique == null || !unique) {
                    builder.aggregate(builder.groupKey(),
                                      builder.aggregateCall(SqlStdOperatorTable.SINGLE_VALUE, false, null, null,
                                                            builder.field(0)));
                }
