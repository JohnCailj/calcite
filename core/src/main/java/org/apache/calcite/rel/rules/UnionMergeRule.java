...
public class UnionMergeRule extends RelOptRule {
    ...
    public static final UnionMergeRule INSTANCE           = new UnionMergeRule(LogicalUnion.class, "UnionMergeRule",
                                                                               RelFactories.LOGICAL_BUILDER);
    public static final UnionMergeRule INTERSECT_INSTANCE = new UnionMergeRule(LogicalIntersect.class,
                                                                               "IntersectMergeRule",
                                                                               RelFactories.LOGICAL_BUILDER);
    public static final UnionMergeRule MINUS_INSTANCE     = new UnionMergeRule(LogicalMinus.class, "MinusMergeRule",
                                                                               RelFactories.LOGICAL_BUILDER);
    ...
    public UnionMergeRule(Class<? extends SetOp> unionClazz, String description, RelBuilderFactory relBuilderFactory) {
        super(operand(unionClazz, operand(RelNode.class, any()), operand(RelNode.class, any())), relBuilderFactory,
              description);
    }
    ...
    public void onMatch(RelOptRuleCall call) {
        ...
        @SuppressWarnings("unchecked") final Class<? extends SetOp> setOpClass = (Class) operands.get(
                0).getMatchedClass();
