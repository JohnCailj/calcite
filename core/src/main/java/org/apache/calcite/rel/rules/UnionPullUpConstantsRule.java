...
public class UnionPullUpConstantsRule extends RelOptRule {
    ...
    public static final UnionPullUpConstantsRule INSTANCE = new UnionPullUpConstantsRule(Union.class,
    ...
    @Override public void onMatch(RelOptRuleCall call) {
        ...
        for (RelNode input : union.getInputs()) {
            ...
            for (int j : refsIndex) {
                newChildExprs.add(Pair.<RexNode, String>of(rexBuilder.makeInputRef(input, j),
