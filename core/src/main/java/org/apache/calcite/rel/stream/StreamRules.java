...
public class StreamRules {
    ...
    public static final ImmutableList<RelOptRule> RULES = ImmutableList.of(new DeltaProjectTransposeRule(),
    ...
    public static class DeltaProjectTransposeRule extends RelOptRule {
        ...
        private DeltaProjectTransposeRule() {
            super(operand(Delta.class, operand(Project.class, any())));
        }
        ...
        @Override public void onMatch(RelOptRuleCall call) {
            ...
            final LogicalProject newProject = LogicalProject.create(newDelta, project.getProjects(),
    ...
    public static class DeltaFilterTransposeRule extends RelOptRule {
        ...
        private DeltaFilterTransposeRule() {
            super(operand(Delta.class, operand(Filter.class, any())));
        }
    ...
    public static class DeltaAggregateTransposeRule extends RelOptRule {
        ...
        private DeltaAggregateTransposeRule() {
            super(operand(Delta.class, operand(Aggregate.class, null, Aggregate.NO_INDICATOR, any())));
        }
        ...
        @Override public void onMatch(RelOptRuleCall call) {
            ...
            final LogicalAggregate newAggregate = LogicalAggregate.create(newDelta, aggregate.getGroupSet(),
                                                                          aggregate.groupSets,
    ...
    public static class DeltaSortTransposeRule extends RelOptRule {
        ...
        private DeltaSortTransposeRule() {
            super(operand(Delta.class, operand(Sort.class, any())));
        }
    ...
    public static class DeltaUnionTransposeRule extends RelOptRule {
        ...
        private DeltaUnionTransposeRule() {
            super(operand(Delta.class, operand(Union.class, any())));
        }
    ...
    public static class DeltaTableScanRule extends RelOptRule {
        ...
        private DeltaTableScanRule() {
            super(operand(Delta.class, operand(TableScan.class, none())));
        }
        ...
        @Override public void onMatch(RelOptRuleCall call) {
            ...
            if (streamableTable != null) {
                ...
                final RelOptTable relOptTable2 = RelOptTableImpl.create(relOptTable.getRelOptSchema(),
                                                                        relOptTable.getRowType(), table1,
                                                                        ImmutableList.<String>builder().addAll(
                                                                                relOptTable.getQualifiedName()).add(
                                                                                "(STREAM)").build());
    ...
    public static class DeltaJoinTransposeRule extends RelOptRule {
        ...
        public DeltaJoinTransposeRule() {
            super(operand(Delta.class, operand(Join.class, any())));
        }
