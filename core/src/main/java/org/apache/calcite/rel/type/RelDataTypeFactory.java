...
public interface RelDataTypeFactory {
     ...
     */
    @SuppressWarnings("deprecation") FieldInfoBuilder builder();
     ...
     * a list of fields.
     */
    @Deprecated @SuppressWarnings("deprecation") class FieldInfoBuilder extends Builder implements FieldInfo {
        ...
        @Override public FieldInfoBuilder add(String name, SqlTypeName typeName, int precision) {
            return (FieldInfoBuilder) super.add(name, typeName, precision);
        }

        @Override public FieldInfoBuilder add(String name, SqlTypeName typeName, int precision, int scale) {
            return (FieldInfoBuilder) super.add(name, typeName, precision, scale);
        }

        @Override public FieldInfoBuilder add(String name, TimeUnit startUnit, int startPrecision, TimeUnit endUnit,
        ...
        @Override public FieldInfoBuilder addAll(Iterable<? extends Map.Entry<String, RelDataType>> fields) {
    ...
    class Builder {
         ...
         */
        public Builder add(String name, TimeUnit startUnit, int startPrecision, TimeUnit endUnit,
                           int fractionalSecondPrecision) {
            final SqlIntervalQualifier q = new SqlIntervalQualifier(startUnit, startPrecision, endUnit,
        ...
        public Builder nullable(boolean nullable) {
            ...
            if (lastType.isNullable() != nullable) {
                final RelDataType type = typeFactory.createTypeWithNullability(lastType, nullable);
