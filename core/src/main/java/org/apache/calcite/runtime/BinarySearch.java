...
public class BinarySearch {
    ...
    public static <T> int lowerBound(T[] a, T key, Comparator<T> comparator) {
        return lowerBound(a, key, 0, a.length - 1, Functions.<T>identitySelector(), comparator);
    }
    ...
    public static <T> int upperBound(T[] a, T key, Comparator<T> comparator) {
        return upperBound(a, key, 0, a.length - 1, Functions.<T>identitySelector(), comparator);
    }
    ...
    public static <T> int lowerBound(T[] a, T key, int imin, int imax, Comparator<T> comparator) {
        return lowerBound(a, key, imin, imax, Functions.<T>identitySelector(), comparator);
    }
    ...
    public static <T> int upperBound(T[] a, T key, int imin, int imax, Comparator<T> comparator) {
        return upperBound(a, key, imin, imax, Functions.<T>identitySelector(), comparator);
    }
     ...
     */
    public static <T, K> int lowerBound(T[] a, K key, int imin, int imax, Function1<T, K> keySelector,
     ...
     */
    public static <T, K> int upperBound(T[] a, K key, int imin, int imax, Function1<T, K> keySelector,
                                        Comparator<K> comparator) {
        int initialMax = imax;
        // continually narrow search until just one element remains
        while (imin < imax) {
