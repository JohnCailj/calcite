...
public class CalciteContextException extends CalciteException {
     ...
     */
    public CalciteContextException(String message, Throwable cause, int posLine, int posColumn, int endPosLine,
                                   int endPosColumn) {
        super(message, cause);
        assert cause != null;
     ...
     * @param endPosColumn 1-based end column number
     */
    public void setPosition(int posLine, int posColumn, int endPosLine, int endPosColumn) {
        this.posLine = posLine;
        this.posColumn = posColumn;
