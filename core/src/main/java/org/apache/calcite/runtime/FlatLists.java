...
public class FlatLists {
     ...
     * @return List containing the given members
     */
    private static <T extends Object & Comparable> ComparableList<T> flatList_(T[] t, boolean copy) {
        switch (t.length) {
            case 0:
                //noinspection unchecked
                return COMPARABLE_EMPTY_LIST;
     ...
     * @param <T> Element type
     */
    protected static class Flat1List<T> extends AbstractFlatList<T> implements ComparableList<T> {
        ...
        @SuppressWarnings({ "unchecked" }) public <T2> T2[] toArray(T2[] a) {
            a[0] = (T2) t0;
            return a;
        }
     ...
     * @param <T> Element type
     */
    protected static class Flat3List<T> extends AbstractFlatList<T> implements ComparableList<T> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Flat3List) {
                ...
                return Objects.equals(this.t0, that.t0) && Objects.equals(this.t1, that.t1) && Objects.equals(this.t2,
                                                                                                              that.t2);
            }
     ...
     * @param <T> Element type
     */
    protected static class Flat4List<T> extends AbstractFlatList<T> implements ComparableList<T> {
     ...
     * @param <T> Element type
     */
    protected static class Flat5List<T> extends AbstractFlatList<T> implements ComparableList<T> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Flat5List) {
                ...
                return Objects.equals(this.t0, that.t0) && Objects.equals(this.t1, that.t1) && Objects.equals(this.t2,
                                                                                                              that.t2)
                       && Objects.equals(this.t3, that.t3) && Objects.equals(this.t4, that.t4);
            }
            return o.equals(this);
        }
     ...
     * @param <T> Element type
     */
    protected static class Flat6List<T> extends AbstractFlatList<T> implements ComparableList<T> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Flat6List) {
                ...
                return Objects.equals(this.t0, that.t0) && Objects.equals(this.t1, that.t1) && Objects.equals(this.t2,
                                                                                                              that.t2)
                       && Objects.equals(this.t3, that.t3) && Objects.equals(this.t4, that.t4) && Objects.equals(
                        this.t5, that.t5);
            }
            return o.equals(this);
        }
     ...
     * @param <T> element type
     */
    static class ComparableListImpl<T extends Comparable<T>> extends AbstractList<T> implements ComparableList<T> {
