...
public class AggregateFunctionImpl implements AggregateFunction, ImplementableAggFunction {
     ...
     */
    private AggregateFunctionImpl(Class<?> declaringClass, List<FunctionParameter> params, List<Class<?>> valueTypes,
                                  Class<?> accumulatorType, Class<?> resultType, Method initMethod, Method addMethod,
                                  Method mergeMethod, Method resultMethod) {
    ...
    public static AggregateFunctionImpl create(Class<?> clazz) {
        ...
        if (initMethod != null && addMethod != null) {
            ...
            final List<Class> addParamTypes = ImmutableList.copyOf((Class[]) addMethod.getParameterTypes());
            ...
            return new AggregateFunctionImpl(clazz, params.build(), valueTypes.build(), accumulatorType, resultType,
                                             initMethod, addMethod, mergeMethod, resultMethod);
        }
        return null;
    }
