...
public class TableFunctionImpl extends ReflectiveFunctionBase implements TableFunction, ImplementableFunction {
        ...
        return RexImpTable.createImplementor(new ReflectiveCallNotNullImplementor(method) {
            ...
            public Expression implement(RexToLixTranslator translator, RexCall call,
                ...
                if (QueryableTable.class.isAssignableFrom(returnType)) {
                    Expression queryable = Expressions.call(Expressions.convert_(expr, QueryableTable.class),
    ...
    private Table apply(List<Object> arguments) {
        try {
            ...
            throw RESOURCE.illegalArgumentForTableFunctionCall(method.toString(),
