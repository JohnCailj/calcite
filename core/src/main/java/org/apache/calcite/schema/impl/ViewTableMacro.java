...
public class ViewTableMacro implements TableMacro {
     ...
     *                   of {@code viewSql})
     */
    public ViewTableMacro(CalciteSchema schema, String viewSql, List<String> schemaPath, List<String> viewPath,
                          Boolean modifiable) {
    ...
    public TranslatableTable apply(List<Object> arguments) {
        ...
        CalcitePrepare.AnalyzeViewResult parsed = Schemas.analyzeView(connection, schema, schemaPath, viewSql, viewPath,
     ...
     */
    protected ModifiableViewTable modifiableViewTable(CalcitePrepare.AnalyzeViewResult parsed, String viewSql,
        ...
        return new ModifiableViewTable(elementType, RelDataTypeImpl.proto(parsed.rowType), viewSql, schemaPath,
     ...
     */
    protected ViewTable viewTable(CalcitePrepare.AnalyzeViewResult parsed, String viewSql, List<String> schemaPath,
