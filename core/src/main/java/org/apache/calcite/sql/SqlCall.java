...
public abstract class SqlCall extends SqlNode {
    ...
    @SuppressWarnings("unchecked") public <S extends SqlNode> S operand(int i) {
    ...
    public void findValidOptions(SqlValidator validator, SqlValidatorScope scope, SqlParserPos pos,
