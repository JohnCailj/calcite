...
public class SqlCallBinding extends SqlOperatorBinding {
    ...
    public List<SqlNode> permutedOperands(final SqlCall call) {
        ...
        return Lists.transform(operator.getParamNames(), new Function<String, SqlNode>() {
    ...
    @Override public String getColumnListParamInfo(int ordinal, String paramName, List<String> columnList) {
        final SqlNode operand = call.operand(ordinal);
    ...
    public CalciteException newValidationSignatureError() {
        return validator.newValidationError(call, RESOURCE.canNotApplyOp2Type(getOperator().getName(),
