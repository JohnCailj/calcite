...
public class SqlDataTypeSpec extends SqlNode {
     ...
     */
    public SqlDataTypeSpec(final SqlIdentifier typeName, int precision, int scale, String charSetName,
                           TimeZone timeZone, SqlParserPos pos) {
     ...
     */
    public SqlDataTypeSpec(SqlIdentifier collectionsTypeName, SqlIdentifier typeName, int precision, int scale,
     ...
     */
    public SqlDataTypeSpec(SqlIdentifier collectionsTypeName, SqlIdentifier typeName, int precision, int scale,
                           String charSetName, TimeZone timeZone, Boolean nullable, SqlParserPos pos) {
        super(pos);
    ...
    public SqlNode clone(SqlParserPos pos) {
        return (collectionsTypeName != null) ? new SqlDataTypeSpec(collectionsTypeName, typeName, precision, scale,
                                                                   charSetName, pos) : new SqlDataTypeSpec(typeName,
                                                                                                           precision,
                                                                                                           scale,
                                                                                                           charSetName,
                                                                                                           timeZone,
    ...
    public SqlDataTypeSpec withNullable(Boolean nullable) {
        ...
        return new SqlDataTypeSpec(collectionsTypeName, typeName, precision, scale, charSetName, timeZone, nullable,
                                   getParserPosition());
    }
    ...
    public SqlDataTypeSpec getComponentTypeSpec() {
        ...
        return new SqlDataTypeSpec(typeName, precision, scale, charSetName, timeZone, getParserPosition());
    }
    ...
    public RelDataType deriveType(RelDataTypeFactory typeFactory, boolean nullable) {
        ...
        final SqlTypeName sqlTypeName = Preconditions.checkNotNull(SqlTypeName.get(name));
        ...
        if (SqlTypeUtil.inCharFamily(type)) {
            ...
            if (null == charSetName) {
                ...
                String javaCharSetName = Preconditions.checkNotNull(SqlUtil.translateCharacterSetName(charSetName),
                                                                    charSetName);
        ...
        if (null != collectionsTypeName) {
            final String collectionName = collectionsTypeName.getSimple();
            final SqlTypeName collectionsSqlTypeName = Preconditions.checkNotNull(SqlTypeName.get(collectionName),
                                                                                  collectionName);
