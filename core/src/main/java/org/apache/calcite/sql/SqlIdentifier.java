...
public class SqlIdentifier extends SqlNode {
    ...
    private static final Function<String, String> EMPTY_TO_STAR = new Function<String, String>() {
     ...
     */
    public SqlIdentifier(List<String> names, SqlCollation collation, SqlParserPos pos,
    ...
    public static SqlIdentifier star(List<String> names, SqlParserPos pos, List<SqlParserPos> componentPositions) {
        return new SqlIdentifier(Lists.transform(names, STAR_TO_EMPTY), null, pos, componentPositions);
    }
    ...
    public SqlParserPos getComponentParserPosition(int i) {
        ...
        return (componentPositions == null) ? getParserPosition() : componentPositions.get(i);
    }
    ...
    public SqlIdentifier plusStar() {
        ...
        return new SqlIdentifier(Lists.transform(id.names, STAR_TO_EMPTY), null, id.pos, id.componentPositions);
    }
