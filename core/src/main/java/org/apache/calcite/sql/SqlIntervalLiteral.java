...
public class SqlIntervalLiteral extends SqlLiteral {
    ...
    protected SqlIntervalLiteral(int sign, String intervalStr, SqlIntervalQualifier intervalQualifier,
    ...
    @SuppressWarnings("deprecation") public int signum() {
    ...
    public static class IntervalValue {
        ...
        public boolean equals(Object obj) {
            ...
            return this.intervalStr.equals(that.intervalStr) && (this.sign == that.sign)
