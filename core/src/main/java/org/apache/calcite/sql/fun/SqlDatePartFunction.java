...
public class SqlDatePartFunction extends SqlFunction {
    ...
    public SqlDatePartFunction(String name, TimeUnit timeUnit) {
        super(name, SqlKind.OTHER, ReturnTypes.BIGINT_NULLABLE, InferTypes.FIRST_KNOWN, OperandTypes.DATETIME,
    ...
    @Override public SqlNode rewriteCall(SqlValidator validator, SqlCall call) {
        ...
        return SqlStdOperatorTable.EXTRACT.createCall(pos, new SqlIntervalQualifier(timeUnit, null, SqlParserPos.ZERO),
                                                      operands.get(0));
    }
