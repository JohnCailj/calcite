...
class SqlGroupFunction extends SqlFunction {
     ...
     */
    SqlGroupFunction(SqlKind kind, SqlGroupFunction groupFunction, SqlOperandTypeChecker operandTypeChecker) {
        super(kind.name(), kind, ReturnTypes.ARG0, null, operandTypeChecker, SqlFunctionCategory.SYSTEM);
