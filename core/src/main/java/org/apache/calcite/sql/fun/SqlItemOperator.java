...
class SqlItemOperator extends SqlSpecialOperator {
    ...
    private static final SqlSingleOperandTypeChecker ARRAY_OR_MAP = OperandTypes.or(
            OperandTypes.family(SqlTypeFamily.ARRAY), OperandTypes.family(SqlTypeFamily.MAP),
    ...
    @Override public ReduceResult reduceExpr(int ordinal, TokenSequence list) {
        ...
        return new ReduceResult(ordinal - 1, ordinal + 2, createCall(
