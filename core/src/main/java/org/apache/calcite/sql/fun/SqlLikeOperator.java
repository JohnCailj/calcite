...
public class SqlLikeOperator extends SqlSpecialOperator {
    ...
    SqlLikeOperator(String name, SqlKind kind, boolean negated) {
        ...
        super(name, kind, 32, false, ReturnTypes.BOOLEAN_NULLABLE, InferTypes.FIRST_KNOWN,
        ...
        switch (callBinding.getOperandCount()) {
            ...
            default:
                throw new AssertionError(
                        "unexpected number of args to " + callBinding.getCall() + ": " + callBinding.getOperandCount());
        }
