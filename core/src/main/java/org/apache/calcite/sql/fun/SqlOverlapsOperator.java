...
public class SqlOverlapsOperator extends SqlBinaryOperator {
    ...
    SqlOverlapsOperator(SqlKind kind) {
        super(kind.sql, kind, 30, true, ReturnTypes.BOOLEAN_NULLABLE, InferTypes.FIRST_KNOWN,
    ...
    public String getAllowedSignatures(String opName) {
        ...
        String[] typeNames = { d, d, d, i, i, d, i, i };
        ...
        for (int y = 0; y < typeNames.length; y += 2) {
            ...
            ret.append(
                    SqlUtil.getAliasedSignature(this, opName, ImmutableList.of(d, typeNames[y], d, typeNames[y + 1])));
        }
        return ret.toString();
    }
