...
public class SqlSubstringFunction extends SqlFunction {
    ...
    SqlSubstringFunction() {
        super("SUBSTRING", SqlKind.OTHER_FUNCTION, ReturnTypes.ARG0_NULLABLE_VARYING, null, null,
    ...
    @Override public SqlMonotonicity getMonotonicity(SqlOperatorBinding call) {
        ...
        if (call.getOperandCount() == 3) {
            ...
            if ((mono0 != SqlMonotonicity.NOT_MONOTONIC) && call.getOperandMonotonicity(1) == SqlMonotonicity.CONSTANT
                && call.getOperandLiteralValue(1) instanceof BigDecimal && call.getOperandLiteralValue(1).equals(
                    BigDecimal.ZERO) && call.getOperandMonotonicity(2) == SqlMonotonicity.CONSTANT) {
