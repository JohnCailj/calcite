...
public class SqlTrimFunction extends SqlFunction {
    ...
    protected static final SqlTrimFunction INSTANCE = new SqlTrimFunction("TRIM", SqlKind.TRIM,
                                                                          ReturnTypes.cascade(ReturnTypes.ARG2,
    ...
    public SqlTrimFunction(String name, SqlKind kind, SqlTypeTransformCascade returnTypeInference,
    ...
    public SqlCall createCall(SqlLiteral functionQualifier, SqlParserPos pos, SqlNode... operands) {
        ...
        switch (operands.length) {
            case 1:
                ...
                operands = new SqlNode[] { Flag.BOTH.symbol(SqlParserPos.ZERO), SqlLiteral.createCharString(" ", pos),
                                           operands[0] };
                break;
            case 3:
    ...
    public boolean checkOperandTypes(SqlCallBinding callBinding, boolean throwOnFailure) {
        ...
        switch (kind) {
            case TRIM:
                return SqlTypeUtil.isCharTypeComparable(callBinding, ImmutableList.of(callBinding.operand(1),
