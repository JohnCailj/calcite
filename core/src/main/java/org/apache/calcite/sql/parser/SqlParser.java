...
public class SqlParser {
    ...
    public SqlNode parseExpression() throws SqlParseException {
        try {
            ...
            if ((ex instanceof CalciteContextException) && (originalInput != null)) {
                ((CalciteContextException) ex).setOriginalStatement(originalInput);
            }
    ...
    public static class ConfigBuilder {
        ...
        private boolean              allowBangEqual      = SqlConformanceEnum.DEFAULT.isBangEqualAllowed();
        ...
        public ConfigBuilder setAllowBangEqual(final boolean allowBangEqual) {
            if (allowBangEqual != conformance.isBangEqualAllowed()) {
                setConformance(new SqlDelegatingConformance(conformance) {
         ...
         */
        public Config build() {
            return new ConfigImpl(identifierMaxLength, quotedCasing, unquotedCasing, quoting, caseSensitive,
                                  conformance, parserFactory);
        }
    ...
    private static class ConfigImpl implements Config {
        ...
        private ConfigImpl(int identifierMaxLength, Casing quotedCasing, Casing unquotedCasing, Quoting quoting,
                           boolean caseSensitive, SqlConformance conformance, SqlParserImplFactory parserFactory) {
            this.identifierMaxLength = identifierMaxLength;
            this.caseSensitive = caseSensitive;
