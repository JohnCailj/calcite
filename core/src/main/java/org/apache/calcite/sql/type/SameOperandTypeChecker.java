...
public class SameOperandTypeChecker implements SqlSingleOperandTypeChecker {
    ...
    protected List<Integer> getOperandList(int operandCount) {
        return nOperands == -1 ? Util.range(0, operandCount) : Util.range(0, nOperands);
    }
    ...
    public String getAllowedSignatures(SqlOperator op, String opName) {
        ...
        return SqlUtil.getAliasedSignature(op, opName, nOperands == -1 ? ImmutableList.of(typeName, typeName,
                                                                                          "...") : Collections.nCopies(
                nOperands, typeName));
    }
