        ...
        for (int i = 0; i < argTypes.length; i++) {
            ...
            if (fields.size() != colCount) {
                if (throwOnFailure) {
                    ...
                    throw validator.newValidationError(node, RESOURCE.columnCountMismatchInSetop(
        ...
        for (int i = 0; i < colCount; i++) {
            ...
            if (type == null) {
                if (throwOnFailure) {
                    ...
                    throw validator.newValidationError(field, RESOURCE.columnTypeMismatchInSetop(i + 1, // 1-based
                                                                                                 callBinding.getOperator().getName()));
                } else {
                    return false;
                }
