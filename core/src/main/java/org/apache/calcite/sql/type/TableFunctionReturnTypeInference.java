...
public class TableFunctionReturnTypeInference extends ExplicitReturnTypeInference {
    ...
    public TableFunctionReturnTypeInference(RelProtoDataType unexpandedOutputType, List<String> paramNames,
        ...
        for (RelDataTypeField field : unexpandedOutputType.getFieldList()) {
            ...
            if (isRowOp) {
                for (String columnName : columnNames) {
                    ...
                    addOutputColumn(expandedFieldNames, expandedOutputTypes, iInputColumn, iCursor, opBinding,
                                    cursorField);
                }
            } else {
                iInputColumn = -1;
    ...
    private void addOutputColumn(List<String> expandedFieldNames, List<RelDataType> expandedOutputTypes,
                                 int iInputColumn, int iCursor, SqlOperatorBinding opBinding,
        ...
        RelDataType nullableType = opBinding.getTypeFactory().createTypeWithNullability(cursorField.getType(),
                                                                                        nullable);
