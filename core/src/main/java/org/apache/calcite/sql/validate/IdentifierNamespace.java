...
public class IdentifierNamespace extends AbstractNamespace {
     ...
     */
    IdentifierNamespace(SqlValidatorImpl validator, SqlIdentifier id, @Nullable SqlNodeList extendList,
    ...
    IdentifierNamespace(SqlValidatorImpl validator, SqlNode node, SqlNode enclosingNode,
    ...
    private SqlValidatorNamespace resolveImpl(SqlIdentifier id) {
        ...
        try {
            ...
            if (e.depth == 1) {
                throw validator.newValidationError(id, RESOURCE.cyclicDefinition(id.toString(),
        ...
        if (resolved.count() == 1) {
            ...
            if (!nameMatcher.isCaseSensitive()) {
                throw validator.newValidationError(id, RESOURCE.objectNotFoundWithin(resolve.remainingNames.get(0),
                                                                                     SqlIdentifier.getString(
            ...
            if (resolved.count() == 1) {
                ...
                if (resolve.remainingNames.isEmpty() || previousResolve == null) {
                    ...
                    if (prefix.isEmpty()) {
                        ...
                        throw validator.newValidationError(id, RESOURCE.objectNotFoundWithinDidYouMean(names.get(i),
                                                                                                       SqlIdentifier.getString(
                                                                                                               prefix),
                                                                                                       next));
                    }
            ...
            if (validator.shouldExpandIdentifiers()) {
                ...
                if (qualifiedNames != null) {
                    ...
                    List<SqlParserPos> poses = new ArrayList<>(
                            Collections.nCopies(qualifiedNames.size(), id.getParserPosition()));
