...
class ScopeChild {
    ...
    static final Function<ScopeChild, SqlValidatorNamespace> NAMESPACE_FN = new Function<ScopeChild, SqlValidatorNamespace>() {
    ...
    static final Function<ScopeChild, String> NAME_FN = new Function<ScopeChild, String>() {
