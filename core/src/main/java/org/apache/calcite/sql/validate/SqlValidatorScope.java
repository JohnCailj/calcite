...
public interface SqlValidatorScope {
    ...
    interface Resolved {
        ...
        void found(SqlValidatorNamespace namespace, boolean nullable, SqlValidatorScope scope, Path path,
    ...
    abstract class Path {
         ...
         * The empty path.
         */
        @SuppressWarnings("StaticInitializerReferencesSubClass") public static final EmptyPath EMPTY = new EmptyPath();
        ...
        List<String> stepNames() {
            return Lists.transform(steps(), new Function<Step, String>() {
    ...
    class Resolve {
        ...
        Resolve(SqlValidatorNamespace namespace, boolean nullable, SqlValidatorScope scope, Path path,
            ...
            this.remainingNames =
                    remainingNames == null ? ImmutableList.<String>of() : ImmutableList.copyOf(remainingNames);
        }
        ...
        public RelDataType rowType() {
            return namespace.getValidator().getTypeFactory().createTypeWithNullability(namespace.getRowType(),
                                                                                       nullable);
        }
    }
}
