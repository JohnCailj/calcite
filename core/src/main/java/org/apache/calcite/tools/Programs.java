...
public class Programs {
    ...
    public static final ImmutableSet<RelOptRule> RULE_SET = ImmutableSet.of(EnumerableRules.ENUMERABLE_JOIN_RULE,
                                                                            ...
                                                                            SemiJoinRule.PROJECT, SemiJoinRule.JOIN,
        ...
        return new Program() {
            ...
            public RelNode run(RelOptPlanner planner, RelNode rel, RelTraitSet requiredOutputTraits,
                ...
                if (joinCount < minJoinCount) {
                    ...
                    final HepProgram hep = new HepProgramBuilder().addRuleInstance(
                            FilterJoinRule.FILTER_ON_JOIN).addMatchOrder(HepMatchOrder.BOTTOM_UP).addRuleInstance(
                            JoinToMultiJoinRule.INSTANCE).build();
    ...
    public static Program standard(RelMetadataProvider metadataProvider) {
        ...
        final Program program1 = new Program() {
            ...
            public RelNode run(RelOptPlanner planner, RelNode rel, RelTraitSet requiredOutputTraits,
                ...
                final RelNode rootRel2 = rel.getTraitSet().equals(requiredOutputTraits) ? rel : planner.changeTraits(
                        rel, requiredOutputTraits);
