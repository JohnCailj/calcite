...
public interface Compatible {
    ...
    class Factory {
        ...
        Compatible create() {
            return (Compatible) Proxy.newProxyInstance(Compatible.class.getClassLoader(),
                                                       new Class<?>[] { Compatible.class }, new InvocationHandler() {
                        ...
                        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                            if (method.getName().equals("asMap")) {
                                ...
                                try {
                                    ...
                                    final Method guavaMethod = Maps.class.getMethod(method.getName(),
                            ...
                            if (method.getName().equals("setSchema")) {
                                ...
                                final Method method1 = connection.getClass().getMethod("setSchema", String.class);
                            ...
                            if (method.getName().equals("getParameterName")) {
                                ...
                                try {
                                    final Method method1 = m.getClass().getMethod("getParameters");
