...
public class ImmutableIntList extends FlatLists.AbstractFlatList<Integer> {
    ...
    public static ImmutableIntList copyOf(Iterable<? extends Number> list) {
        ...
        @SuppressWarnings("unchecked") final Collection<? extends Number> collection = list instanceof Collection ? (Collection<? extends Number>) list : Lists.newArrayList(
                list);
    ...
    @Override public boolean equals(Object obj) {
        return this == obj || obj instanceof ImmutableIntList ? Arrays.equals(ints, ((ImmutableIntList) obj).ints) :
    ...
    public <T> T[] toArray(T[] a) {
        ...
        if (a.length < size) {
            ...
            a = a.getClass() == Object[].class ? (T[]) new Object[size] : (T[]) Array.newInstance(
