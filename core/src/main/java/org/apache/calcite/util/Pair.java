...
public class Pair<T1, T2> implements Comparable<Pair<T1, T2>>, Map.Entry<T1, T2>, Serializable {
    ...
    public boolean equals(Object obj) {
        return this == obj || (obj instanceof Pair) && Objects.equals(this.left, ((Pair) obj).left) && Objects.equals(
                this.right, ((Pair) obj).right);
    }
        ...
        return new Iterable<Pair<K, V>>() {
            ...
            public Iterator<Pair<K, V>> iterator() {
                ...
                return new Iterator<Pair<K, V>>() {
                    ...
                    @SuppressWarnings("unchecked") public Pair<K, V> next() {
    ...
    public static <L, R> Iterable<L> left(final Iterable<? extends Map.Entry<L, R>> iterable) {
        return new Iterable<L>() {
            ...
            public Iterator<L> iterator() {
                final Iterator<? extends Map.Entry<L, R>> iterator = iterable.iterator();
