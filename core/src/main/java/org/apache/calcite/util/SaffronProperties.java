...
public interface SaffronProperties {
     ...
     */
    @Resource("saffron.opt.allowInfiniteCostConverters") @Default("true") BooleanProp allowInfiniteCostConverters();
     ...
     */
    @Resource("saffron.default.charset") @Default("ISO-8859-1") StringProp defaultCharset();
     ...
     */
    @Resource("saffron.default.nationalcharset") @Default("ISO-8859-1") StringProp defaultNationalCharset();
     ...
     * {@link org.apache.calcite.sql.SqlLiteral#SqlLiteral}
     */
    @Resource("saffron.default.collation.name") @Default("ISO-8859-1$en_US") StringProp defaultCollation();
     ...
     * {@link org.apache.calcite.sql.SqlLiteral#SqlLiteral}
     */
    @Resource("saffron.default.collation.strength") @Default("primary") StringProp defaultCollationStrength();
