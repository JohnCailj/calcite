...
public class TimestampString implements Comparable<TimestampString> {
    ...
    @Override public boolean equals(Object o) {
        ...
        return o == this || o instanceof TimestampString && ((TimestampString) o).v.equals(v);
    }
    ...
    public static TimestampString fromCalendarFields(Calendar calendar) {
        return new TimestampString(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH) + 1,
                                   calendar.get(Calendar.DAY_OF_MONTH), calendar.get(Calendar.HOUR_OF_DAY),
                                   calendar.get(Calendar.MINUTE), calendar.get(Calendar.SECOND)).withMillis(
    ...
    public long getMillisSinceEpoch() {
        ...
        return d * DateTimeUtils.MILLIS_PER_DAY + h * DateTimeUtils.MILLIS_PER_HOUR
               + m * DateTimeUtils.MILLIS_PER_MINUTE + s * DateTimeUtils.MILLIS_PER_SECOND + ms;
    }
    ...
    public static TimestampString fromMillisSinceEpoch(long millis) {
        return new TimestampString(DateTimeUtils.unixTimestampToString(millis)).withMillis(
