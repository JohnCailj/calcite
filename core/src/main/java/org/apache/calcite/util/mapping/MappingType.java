...
public enum MappingType {
    ...
    MappingType() {
        this.inverseOrdinal = ((ordinal() & 3) << 2) | ((ordinal() & 12) >> 2);
    }
    ...
    public boolean isSurjection() {
        return (ordinal() & (OPTIONAL_TARGET | MULTIPLE_TARGET | OPTIONAL_SOURCE)) == 0;
    }
    ...
    public boolean isInjection() {
        return (ordinal() & (OPTIONAL_TARGET | MULTIPLE_TARGET | MULTIPLE_SOURCE)) == 0;
    }
    ...
    public boolean isBijection() {
        return (ordinal() & (OPTIONAL_TARGET | MULTIPLE_TARGET | OPTIONAL_SOURCE | MULTIPLE_SOURCE)) == 0;
    }
