...
public class VolcanoPlannerTest {
    ...
    @Test public void testSubsetRule() {
        ...
        RelNode result = planner.chooseDelegate().findBestExp();
        assertTrue(result instanceof PhysSingleRel);
        assertThat(sort(buf), equalTo(sort("NoneSingleRel:Subset#0.NONE", "PhysSingleRel:Subset#0.NONE",
    ...
    private void removeTrivialProject(boolean useRule) {
        ...
        planner.addRule(new ConverterRule(RelNode.class, PHYS_CALLING_CONVENTION, EnumerableConvention.INSTANCE,
                                          "PhysToIteratorRule") {
        ...
        RelNode projectRel = RelOptUtil.createProject(leafRel, ImmutableList.of(inputRef), ImmutableList.of("this"));
     ...
     */
    @Ignore @Test public void testListener() {
    ...
    private void checkEvent(List<RelOptListener.RelEvent> eventList, int iEvent, Class expectedEventClass,
                            RelNode expectedRel, Class<? extends RelOptRule> expectedRuleClass) {
    ...
    class PhysToIteratorConverter extends ConverterImpl {
        ...
        public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
            ...
            return new PhysToIteratorConverter(getCluster(), sole(inputs));
        }
    }
