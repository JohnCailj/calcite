...
public class RexBuilderTest {
    ...
    @Test public void testEnsureTypeWithAny() {
        ...
        RexNode node = new RexLiteral(Boolean.TRUE, typeFactory.createSqlType(SqlTypeName.BOOLEAN),
                                      SqlTypeName.BOOLEAN);
    ...
    @Test public void testEnsureTypeWithItself() {
        ...
        RexNode node = new RexLiteral(Boolean.TRUE, typeFactory.createSqlType(SqlTypeName.BOOLEAN),
                                      SqlTypeName.BOOLEAN);
        RexNode ensuredNode = builder.ensureType(typeFactory.createSqlType(SqlTypeName.BOOLEAN), node, true);
    ...
    @Test public void testTimestampLiteral() {
        ...
        assertThat(((RexLiteral) literal3b).getValueAs(TimestampString.class).toString(),
    ...
    @Test public void testTimestampWithLocalTimeZoneLiteral() {
        ...
        // The new way
        final TimestampWithTimeZoneString ts = new TimestampWithTimeZoneString(1969, 7, 21, 2, 56, 15,
