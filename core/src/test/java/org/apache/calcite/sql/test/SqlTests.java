...
import static org.apache.calcite.sql.test.SqlTester.*;
...
public abstract class SqlTests {
     ...
     */
    public static final TypeChecker ANY_TYPE_CHECKER = new TypeChecker() {
     ...
     */
    public static final ParameterChecker ANY_PARAMETER_CHECKER = new ParameterChecker() {
    ...
    private static class SqlTypeChecker implements TypeChecker {
        ...
        public void checkType(RelDataType type) {
            assertEquals(typeName.toString(), type.toString());
        }
    }
     ...
     */
    public static final ResultChecker ANY_RESULT_CHECKER = new ResultChecker() {
