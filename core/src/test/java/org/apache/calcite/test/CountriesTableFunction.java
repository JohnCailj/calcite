...
public class CountriesTableFunction {
    ...
    private static final Object[][] ROWS = { { "AD", 42.546245, 1.601554, "Andorra" },
                                             ...
                                             { "GR", 39.074208, 21.824312, "Greece" }, { "GS", -54.429579, -36.587909,
                                             ...
                                             { "HR", 45.1, 15.2, "Croatia" }, { "HT", 18.971187, -72.285215, "Haiti" },
    ...
    public static ScannableTable eval(boolean b) {
        return new ScannableTable() {
            ...
            public RelDataType getRowType(RelDataTypeFactory typeFactory) {
                return typeFactory.builder().add("country", SqlTypeName.VARCHAR).add("latitude",
                                                                                     SqlTypeName.DECIMAL).nullable(
                        true).add("longitude", SqlTypeName.DECIMAL).nullable(true).add("name",
