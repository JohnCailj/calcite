...
public class ExceptionMessageTest {
     ...
     */
    @SuppressWarnings("UnusedDeclaration") public static class TestSchema {
    ...
    @Test public void testNonSqlException() throws SQLException {
        try {
            ...
            assertThat(e.getMessage(), equalTo("Error while executing SQL \"select * from \"badEntries\"\": "
    ...
    @Test public void testSyntaxError() {
        try {
            ...
            assertThat(e.getMessage(), equalTo("Error while executing SQL \"invalid sql\": parse failed: "
