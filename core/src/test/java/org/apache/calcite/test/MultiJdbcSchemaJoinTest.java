...
public class MultiJdbcSchemaJoinTest {
    ...
    @Test public void test() throws SQLException, ClassNotFoundException {
        ...
        ResultSet rs = stmt3.executeQuery(
                "select table1.id, table1.field1 " + "from db1.table1 join db2.table2 on table1.id = table2.id");
    ...
    private Connection setup() throws SQLException {
        ...
        SchemaPlus rootSchema = calciteConnection.getRootSchema();
        rootSchema.add("DB",
                       JdbcSchema.create(rootSchema, "DB", JdbcSchema.dataSource(db, "org.hsqldb.jdbcDriver", "", ""),
                                         null, null));
    ...
    @Test public void testEnumerableWithJdbcJoinWithWhereClause() throws SQLException {
