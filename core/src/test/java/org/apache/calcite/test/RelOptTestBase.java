...
abstract class RelOptTestBase extends SqlToRelTestBase {
     ...
     */
    Sql sql(String sql) {
        return new Sql(sql, null, null, ImmutableMap.<Hook, Function>of(),
    ...
    class Sql {
        ...
        Sql(String sql, HepProgram preProgram, HepPlanner hepPlanner, ImmutableMap<Hook, Function> hooks,
        ...
        public Sql expand(final boolean b) {
            return withTransform(new Function<Tester, Tester>() {
