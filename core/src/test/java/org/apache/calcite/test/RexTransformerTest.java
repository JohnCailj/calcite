...
public class RexTransformerTest {
    ...
    @Test public void testPreTests() {
        ...
        node = new RexInputRef(0, typeFactory.createTypeWithNullability(typeFactory.createSqlType(SqlTypeName.BOOLEAN),
                                                                        false));
    ...
    @Test public void testSplitJoinCondition() {
        ...
        final RexNode remaining = RelOptUtil.splitJoinCondition(sysFieldList, join.getInputs().get(0),
