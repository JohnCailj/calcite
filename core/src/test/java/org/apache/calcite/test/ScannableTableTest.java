...
public class ScannableTableTest {
    ...
    @Test public void testSimple() throws Exception {
        ...
        assertThat(CalciteAssert.toString(resultSet), equalTo("i=0\ni=10\ni=20\ni=30\n"));
    }
    ...
    @Test public void testSimpleFilter2() throws Exception {
        ...
        assertThat(CalciteAssert.toString(resultSet), equalTo("i=4; j=John; k=1940\ni=4; j=Paul; k=1942\n"));
        resultSet.close();
    ...
    @Test public void testProjectableFilterable2WithProject() throws Exception {
        ...
        assertThat(CalciteAssert.toString(resultSet), equalTo("k=1940; j=John\nk=1942; j=Paul\n"));
        resultSet.close();
        assertThat(buf.toString(), equalTo("returnCount=2, filter=4, projects=[2, 1]"));
        buf.setLength(0);

        // Filter on one of the projected columns.
        resultSet = statement.executeQuery("select \"i\",\"k\" from\n" + "\"s\".\"beatles\" where \"k\" > 1941");
        assertThat(CalciteAssert.toString(resultSet), equalTo("i=4; k=1942\n" + "i=6; k=1943\n"));
        resultSet.close();
        assertThat(buf.toString(), equalTo("returnCount=4, projects=[0, 2]"));
        buf.setLength(0);
    }
    ...
    @Test public void testPFTableRefusesFilter() throws Exception {
        ...
        resultSet.close();
        assertThat(buf.toString(), equalTo("returnCount=4, projects=[2, 0]"));
        buf.setLength(0);
    }
    ...
    private static Integer getFilter(boolean cooperative, List<RexNode> filters) {
        ...
        while (filterIter.hasNext()) {
            ...
            if (cooperative && node instanceof RexCall && ((RexCall) node).getOperator() == SqlStdOperatorTable.EQUALS
    ...
    public static class BeatlesFilterableTable extends AbstractTable implements FilterableTable {
        ...
        public RelDataType getRowType(RelDataTypeFactory typeFactory) {
            return typeFactory.builder().add("i", SqlTypeName.INTEGER).add("j", SqlTypeName.VARCHAR).add("k",
    ...
    private static final Object[][] BEATLES = { { 4, "John", 1940 }, { 4, "Paul", 1942 }, { 6, "George", 1943 },
                                                { 5, "Ringo", 1940 } };
