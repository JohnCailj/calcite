...
public class SqlLimitsTest {
    ...
    public static List<RelDataType> getTypes(RelDataTypeFactory typeFactory) {
        ...
        return ImmutableList.of(typeFactory.createSqlType(SqlTypeName.BOOLEAN),
    ...
    private void printLimit(PrintWriter pw, String desc, RelDataType type, boolean sign, SqlTypeName.Limit limit,
                            boolean beyond) {
