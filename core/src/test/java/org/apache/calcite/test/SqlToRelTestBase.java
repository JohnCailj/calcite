...
public abstract class SqlToRelTestBase {
    ...
    protected Tester createTester() {
        return new TesterImpl(getDiffRepos(), false, false, true, false, null, null);
    }
    ...
    public interface Tester {
        ...
        Tester withCatalogReaderFactory(Function<RelDataTypeFactory, Prepare.CatalogReader> factory);
    ...
    protected static class MockRelOptSchema implements RelOptSchemaWithSampling {
        ...
        public RelOptTable getTableForMember(List<String> names, final String datasetName, boolean[] usedDataset) {
            ...
            RelOptTable datasetTable = new DelegatingRelOptTable(table) {
        ...
        protected MockColumnSet createColumnSet(SqlValidatorTable table, List<String> names, final RelDataType rowType,
        ...
        protected class MockColumnSet implements RelOptTable {
            ...
            public RelOptTable extend(List<RelDataTypeField> extendedFields) {
                final RelDataType extendedRowType = getRelOptSchema().getTypeFactory().builder().addAll(
                        rowType.getFieldList()).addAll(extendedFields).build();
    ...
    public static class TesterImpl implements Tester {
         ...
         */
        protected TesterImpl(DiffRepository diffRepos, boolean enableDecorrelate, boolean enableTrim,
                             boolean enableExpand, boolean enableLateDecorrelate,
            ...
            this(diffRepos, enableDecorrelate, enableTrim, enableExpand, enableLateDecorrelate, catalogReaderFactory,
                 clusterFactory, SqlToRelConverter.Config.DEFAULT, SqlConformanceEnum.DEFAULT);
        }

        protected TesterImpl(DiffRepository diffRepos, boolean enableDecorrelate, boolean enableTrim,
                             boolean enableExpand, boolean enableLateDecorrelate,
                             Function<RelDataTypeFactory, Prepare.CatalogReader> catalogReaderFactory,
                             Function<RelOptCluster, RelOptCluster> clusterFactory, SqlToRelConverter.Config config,
        ...
        public RelRoot convertSqlToRel(String sql) {
            ...
            if (config == SqlToRelConverter.Config.DEFAULT) {
                localConfig = SqlToRelConverter.configBuilder().withTrimUnusedFields(true).withExpand(
                        enableExpand).build();
            } else {
                localConfig = config;
            }

            final SqlToRelConverter converter = createSqlToRelConverter(validator, catalogReader, typeFactory,
                                                                        localConfig);
        ...
        protected SqlToRelConverter createSqlToRelConverter(final SqlValidator validator,
            ...
            return new SqlToRelConverter(null, validator, catalogReader, cluster, StandardConvertletTable.INSTANCE,
                                         config);
        }
        ...
        public TesterImpl withDecorrelation(boolean enableDecorrelate) {
            return this.enableDecorrelate == enableDecorrelate ? this : new TesterImpl(diffRepos, enableDecorrelate,
                                                                                       enableTrim, enableExpand,
        ...
        public Tester withLateDecorrelation(boolean enableLateDecorrelate) {
            return this.enableLateDecorrelate == enableLateDecorrelate ? this : new TesterImpl(diffRepos,
                                                                                               enableDecorrelate,
                                                                                               enableTrim, enableExpand,
                                                                                               enableLateDecorrelate,
                                                                                               catalogReaderFactory,
        ...
        public TesterImpl withConfig(SqlToRelConverter.Config config) {
            return this.config == config ? this : new TesterImpl(diffRepos, enableDecorrelate, enableTrim, enableExpand,
                                                                 enableLateDecorrelate, catalogReaderFactory,
                                                                 clusterFactory, config, conformance);
        }

        public Tester withTrim(boolean enableTrim) {
            return this.enableTrim == enableTrim ? this : new TesterImpl(diffRepos, enableDecorrelate, enableTrim,
                                                                         enableExpand, enableLateDecorrelate,
                                                                         catalogReaderFactory, clusterFactory, config,
                                                                         conformance);
        }

        public Tester withExpand(boolean enableExpand) {
            return this.enableExpand == enableExpand ? this : new TesterImpl(diffRepos, enableDecorrelate, enableTrim,
                                                                             enableExpand, enableLateDecorrelate,
        ...
        public Tester withConformance(SqlConformance conformance) {
            return new TesterImpl(diffRepos, enableDecorrelate, false, enableExpand, enableLateDecorrelate,
                                  catalogReaderFactory, clusterFactory, config, conformance);
        }

        public Tester withCatalogReaderFactory(Function<RelDataTypeFactory, Prepare.CatalogReader> factory) {
            return new TesterImpl(diffRepos, enableDecorrelate, false, enableExpand, enableLateDecorrelate, factory,
                                  clusterFactory, config, conformance);
        }
