...
public class ChunkListTest {
    ...
    @Test public void testPerformance() {
        ...
        final Iterable<Pair<Function0<List<Integer>>, String>> factories0 = Pair.zip(
                Arrays.asList(new Function0<List<Integer>>() {
        ...
        Iterable<Pair<Integer, String>> sizes = Pair.zip(Arrays.asList(100000, 1000000, 10000000),
        ...
        for (final Pair<Function0<List<Integer>>, String> pair : factories) {
            for (final Pair<Integer, String> size : sizes) {
                ...
                new Benchmark("get from " + size.right + " values, " + (size.left / 1000) + " times, " + pair.right,
                              new Function1<Benchmark.Statistician, Void>() {
        ...
        for (final Pair<Function0<List<Integer>>, String> pair : factories) {
            for (final Pair<Integer, String> size : sizes) {
                ...
                new Benchmark("add " + size.right + " values, delete 10%, insert 20%, get 1%, using " + pair.right,
                              new Function1<Benchmark.Statistician, Void>() {
