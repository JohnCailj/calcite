...
public class ImmutableBitSetTest {
    ...
    @Test public void testCompare2() {
        ...
        assertThat(sorted.toString(), equalTo("[{0, 1, 3}, {0, 1}, {1, 1000}, {1}, {1}, {2, 3}, {}]"));
    }

    private List<ImmutableBitSet> getSortedList() {
        return Arrays.asList(ImmutableBitSet.of(), ImmutableBitSet.of(0, 1), ImmutableBitSet.of(0, 1, 3),
                             ImmutableBitSet.of(1), ImmutableBitSet.of(1), ImmutableBitSet.of(1, 1000),
    ...
    @Test public void testUnion() {
        assertThat(ImmutableBitSet.of(1).union(ImmutableBitSet.of(3)).toString(), equalTo("{1, 3}"));
        assertThat(ImmutableBitSet.of(1).union(ImmutableBitSet.of(3, 100)).toString(), equalTo("{1, 3, 100}"));
        ImmutableBitSet x = ImmutableBitSet.of(1).rebuild().addAll(ImmutableBitSet.of(2)).addAll(
                ImmutableBitSet.of()).addAll(ImmutableBitSet.of(3)).build();
        assertThat(x.toString(), equalTo("{1, 2, 3}"));
    }

    @Test public void testIntersect() {
        assertThat(ImmutableBitSet.of(1, 2, 3, 100, 200).intersect(ImmutableBitSet.of(2, 100)).toString(),
                   equalTo("{2, 100}"));
        assertTrue(
                ImmutableBitSet.of(1, 3, 5, 101, 20001).intersect(ImmutableBitSet.of(2, 100)) == ImmutableBitSet.of());
    }
    ...
    @Test public void testPreviousClearBit() {
        ...
        assertThat(ImmutableBitSet.of(0, 1, 3, 4).previousClearBit(1), equalTo(-1));
        assertThat(ImmutableBitSet.of(1, 3, 4).previousClearBit(1), equalTo(0));
    }

    @Test public void testBuilder() {
        assertThat(ImmutableBitSet.builder().set(9).set(100).set(1000).clear(250).set(88).clear(100).clear(
                1000).build().toString(), equalTo("{9, 88}"));
    }
    ...
    @Test public void testCreateLongs() {
        ...
        assertThat(ImmutableBitSet.valueOf(0xAL), equalTo(ImmutableBitSet.of(1, 3)));
        assertThat(ImmutableBitSet.valueOf(0xAL, 0, 0), equalTo(ImmutableBitSet.of(1, 3)));
        assertThat(ImmutableBitSet.valueOf(0, 0, 0xAL, 0), equalTo(ImmutableBitSet.of(129, 131)));
    }

    @Test public void testCreateLongBuffer() {
        assertThat(ImmutableBitSet.valueOf(LongBuffer.wrap(new long[] {})), equalTo(ImmutableBitSet.of()));
        assertThat(ImmutableBitSet.valueOf(LongBuffer.wrap(new long[] { 0xAL })), equalTo(ImmutableBitSet.of(1, 3)));
        assertThat(ImmutableBitSet.valueOf(LongBuffer.wrap(new long[] { 0, 0, 0xAL, 0 })),
    ...
    @Test public void testToLongArray() {
        ...
        assertThat(ImmutableBitSet.valueOf(bitSet.toLongArray()), equalTo(bitSet));
        assertThat(ImmutableBitSet.valueOf(LongBuffer.wrap(bitSet.toLongArray())), equalTo(bitSet));
    }
    ...
    @Test public void testClear() {
        ...
        assertThat(bitSet.clear(29).clear(4).clear(29).clear(1969), equalTo(ImmutableBitSet.of()));
