...
public class Smalls {
    ...
    public static final Method GENERATE_STRINGS_METHOD     = Types.lookupMethod(Smalls.class, "generateStrings",
                                                                                Integer.class);
    public static final Method MAZE_METHOD                 = Types.lookupMethod(MazeTable.class, "generate", int.class,
                                                                                int.class, int.class);
    public static final Method MAZE2_METHOD                = Types.lookupMethod(MazeTable.class, "generate2", int.class,
                                                                                int.class, Integer.class);
    public static final Method MAZE3_METHOD                = Types.lookupMethod(MazeTable.class, "generate3",
                                                                                String.class);
    public static final Method MULTIPLICATION_TABLE_METHOD = Types.lookupMethod(Smalls.class, "multiplicationTable",
    ...
    public static final Method FIBONACCI2_TABLE_METHOD     = Types.lookupMethod(Smalls.class, "fibonacciTableWithLimit",
                                                                                long.class);
    public static final Method VIEW_METHOD                 = Types.lookupMethod(Smalls.class, "view", String.class);
    public static final Method STR_METHOD                  = Types.lookupMethod(Smalls.class, "str", Object.class,
                                                                                Object.class);
    public static final Method STRING_UNION_METHOD         = Types.lookupMethod(Smalls.class, "stringUnion",
                                                                                Queryable.class, Queryable.class);
    public static final Method PROCESS_CURSOR_METHOD       = Types.lookupMethod(Smalls.class, "processCursor",
                                                                                int.class, Enumerable.class);
    public static final Method PROCESS_CURSORS_METHOD      = Types.lookupMethod(Smalls.class, "processCursors",
                                                                                int.class, Enumerable.class,
                                                                                Enumerable.class);
    ...
    public static QueryableTable processCursor(final int offset, final Enumerable<Object[]> a) {
        return new AbstractQueryableTable(Object[].class) {
            ...
            public <T> Queryable<T> asQueryable(QueryProvider queryProvider, SchemaPlus schema, String tableName) {
                final Enumerable<Integer> enumerable = a.select(new Function1<Object[], Integer>() {
     ...
     */
    public static QueryableTable processCursors(final int offset, final Enumerable<Object[]> a,
                                                final Enumerable<IntString> b) {
        return new AbstractQueryableTable(Object[].class) {
            ...
            public <T> Queryable<T> asQueryable(QueryProvider queryProvider, SchemaPlus schema, String tableName) {
                final Enumerable<Integer> enumerable = a.zip(b, new Function2<Object[], IntString, Integer>() {
    ...
    public static TranslatableTable strView(String s) {
        ...
        }, "values (" + SqlDialect.CALCITE.quoteStringLiteral(s) + ")", ImmutableList.<String>of(),
                             Arrays.asList("view"));
    }
    ...
    public static TranslatableTable str(Object o, Object p) {
        ...
        return new ViewTable(Object.class, new RelProtoDataType() {
           ...
           + SqlDialect.CALCITE.quoteStringLiteral(p.toString()), ImmutableList.<String>of(), Arrays.asList("view"));
    }
     ...
     */
    @Deterministic public static class AllTypesFunction {
    ...
    public static class TableMacroFunctionWithNamedParameters {
        ...
        public TranslatableTable eval(@Parameter(name = "R", optional = true) String r, @Parameter(name = "S") String s,
    ...
    public static class MazeTable extends AbstractTable implements ScannableTable {
        ...
        public static ScannableTable generate2(@Parameter(name = "WIDTH") int width,
    ...
    public static class WideSaleSchema {
        ...
        @SuppressWarnings("unused") public final WideProductSale[] prod = { new WideProductSale(100, 10) };
    }

    /**
     * Table with a lot of columns.
     */
    @SuppressWarnings("unused") public static class WideProductSale {
