...
public class DirectedGraphTest {
    ...
    @Test public void testPaths() {
        ...
        assertEquals("[[A, B, C, E], [A, D, E]]", frozenGraph.getPaths("A", "E").toString());
    ...
    @Test public void testCycleDetection() {
        ...
        graph.addEdge("D", "E");
        assertThat(new CycleDetector<String, DefaultEdge>(graph).findCycles(),
                   CoreMatchers.<Set<String>>equalTo(ImmutableSet.<String>of("C", "D", "E", "F")));
        ...
        assertThat(new CycleDetector<String, DefaultEdge>(graph).findCycles(),
                   CoreMatchers.<Set<String>>equalTo(ImmutableSet.<String>of("B", "C", "D")));
        ...
        graph.addEdge("C", "C");
        assertThat(new CycleDetector<String, DefaultEdge>(graph).findCycles(),
                   CoreMatchers.<Set<String>>equalTo(ImmutableSet.<String>of("C", "D")));
